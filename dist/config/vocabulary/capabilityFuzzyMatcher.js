...
exports.CapabilityFuzzyMatcher = void 0;
class CapabilityFuzzyMatcher {
    constructor() {
        this.ukrainianTriggers = [
     ...
     */
    hasValidCapabilityContext(text) {
    ...
    calculateSimilarity(word1, word2) {
        ...
        if (maxLength === 0)
            return 1.0;
        if (minLength / maxLength < 0.4)
            return 0; // Занадто різні за довжиною
...
exports.CapabilityFuzzyMatcher = CapabilityFuzzyMatcher;
