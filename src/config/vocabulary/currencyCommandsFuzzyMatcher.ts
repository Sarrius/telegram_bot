...
export class CurrencyCommandsFuzzyMatcher {
  ...
  private readonly ratePatterns = [
    // Основні курси валют
    /(?:який\s+)?курс\s+(долар|доллар|євро|евро|фунт|злот|франк)(?:\s+(?:в|у)\s+(?:києві|харкові|одесі|дніпрі|львові|тернополі|полтаві|херсоні|вінниці|черкасах|житомирі|рівному|ужгороді|сумах|луцьку|івано-франківську|чернігові|хмельницькому|чернівцях|кропивницькому|українi|україні))?/i,
    ...
    // Природні запити з географією
    /(?:який\s+)?(?:курс|ціна)\s+(долар|доллар|долара|доллара|доларів|долларів)(?:\s+(?:в|у)\s+(?:києві|харкові|одесі|дніпрі|львові|тернополі|полтаві|херсоні|вінниці|черкасах|житомирі|рівному|ужгороді|сумах|луцьку|івано-франківську|чернігові|хмельницькому|чернівцях|кропивницькому|українi|україні))?/i,
    /(?:який\s+)?(?:курс|ціна)\s+(євро|евро|євра|евра)(?:\s+(?:в|у)\s+(?:києві|харкові|одесі|дніпрі|львові|тернополі|полтаві|херсоні|вінниці|черкасах|житомирі|рівному|ужгороді|сумах|луцьку|івано-франківську|чернігові|хмельницькому|чернівцях|кропивницькому|українi|україні))?/i,
    
    // Звичайні запити про ціну
    /скільки\s+(коштує|стоїть)\s+(долар|доллар|євро|евро|фунт|злот|франк)(?:\s+(?:в|у)\s+(?:києві|харкові|одесі|дніпрі|львові|тернополі|полтаві|херсоні|вінниці|черкасах|житомирі|рівному|ужгороді|сумах|луцьку|івано-франківську|чернігові|хмельницькому|чернівцях|кропивницькому|українi|україні))?/i,
